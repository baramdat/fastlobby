...
<div class="main-container container-fluid">
    ...
    <div class="page-header">
        ...
        <div>
            <h1 class="page-title">Building Admin  List</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(url('/dashboard')); ?>">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Building Admin list</li>
            </ol>
        </div>
        <a role="button" class="btn btn-dealer" href="<?php echo e(url('integrator/user/add')); ?>">
            <span class="fe fe-user-plus fs-14"></span> Add Building Admin</a>
    ...
    <div id="divLoader" class="text-center pt-5" style="display:block;height:300px;">
        <span>
            <i class="bx bx-loader-circle bx-spin"></i> <?php echo e(__('Building Admin are being loading.. It might take few seconds')); ?>.
        </span>
    </div>
    <div class="row text-center" id="divNotFound" style="display:none">
        <h6 class="mt-lg-5" style=""><i class="bx bx-window-close"></i> <?php echo e(__('No Building Admin Found')); ?> !</h6>
    </div>
    <!-- pagination -->
    <div class="row mb-5">
        <div class="col-12">
            ...
            Swal.fire({
                ...
                .then((deleteThis) => {
                    if (deleteThis.isConfirmed) {
                        $.ajax({
                            url: '/api/integrator/delete/user/' + id,
                            type: "delete",
                            dataType: "JSON",
                            success: function(response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\fastlobby.com\resources\views/templates/Integrator/building_admin/list.blade.php ENDPATH**/ ?>