...
<div class="main-container container-fluid">
    ...
    <div class="row">
        <?php echo $__env->make('templates.chat.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
            <div class="card" id="chat">
                <div class="card-header">
                    <h3 class="card-title">Mail Read<?php echo e($receiverId); ?></h3>
                </div>
                <?php if(isset($chats) && sizeof($chats)>0): ?>
                <?php
                ...
                ?>
                <div class="card-body">
                    <div class="email-media" id="row<?php echo e($chat->id); ?>">
                        <div class="mt-0 d-sm-flex">
                            <?php if($sender->image==""): ?>
                            <img class="me-2 rounded-circle avatar avatar-lg" src="<?php echo e(asset('assets/images/users/6.jpg')); ?>" alt="avatar">
                            <?php else: ?>
                            <img class="me-2 rounded-circle avatar avatar-lg" src="<?php echo e(asset('uploads/files/'.$sender->image)); ?>" alt="avatar">
                            <?php endif; ?>

                            <div class="media-body pt-0">
                                <div class="float-md-end d-flex fs-15">
                                    <small class="me-3 mt-3 text-muted"><?php echo e($chat->created_at->diffForHumans()); ?></small>
                                </div>
                                <div class="media-title text-dark font-weight-semibold mt-1"><?php echo e(ucwords($sender->first_name)); ?> <?php echo e(ucwords($sender->last_name)); ?><span class="text-muted font-weight-semibold">( <?php echo e($sender->email); ?> )</span></div>
                                <small class="mb-0">to <?php echo e(ucwords($receiver->first_name)); ?> <?php echo e(ucwords($receiver->last_name)); ?> ( <?php echo e($receiver->email); ?>) </small>
                        ...
                        <div class="email-attch">
                            <p class="font-weight-semibold"><?php echo e($fileCount); ?> Attachments <a href="filemanager-details.html">View</a></p>
                        </div>
                        <div class="row attachments-doc">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 mb-2 mb-sm-0">
                                <div class="border overflow-hidden p-0 br-7">
                                    <a href="<?php echo e(asset('uploads/files/'.$file['filename'])); ?>" target="_blank">
                                        <?php if(in_array($file["ext"],$imgExt)): ?>
                                        <img src="<?php echo e(asset('uploads/files/'.$file['filename'])); ?>" class="card-img-top" alt="img">
                                        <!-- <img src="../assets/images/media/8.jpg" class="card-img-top" alt="img"> -->
                                        <?php endif; ?>
                                    </a>
                                    <div class="p-3 text-center">
                                        <a href="<?php echo e(asset('uploads/files/'.$file['filename'])); ?>" target="_blank" class="fw-semibold fs-15 text-dark text-truncate" style="max-width:100px ;"><?php echo e($file["name"]); ?></a>
                                        <p class="text-muted.ms-2 mb-0 fs-11">(<?php echo e($file["size"]); ?> KB)</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-footer btnDiv">
                    <a class="btn btn-primary mt-1 mb-1 btnReply" href="javascript:void(0)" id="<?php echo e($chat->id); ?>"><i class="fa fa-reply"></i> Reply</a>
                </div>
                <div class="reply_box shadow mb-3 mt-2" style="display: none;">
                    <form id="reply_form">
                        ...
                        <div class="col-12 mt-4">
                            <div class="row">
                                <div class="col-2">
                                    <input type="hidden" name="message_id" id="message_id" value="<?php echo e($chat->id); ?>">
                                    <input type="hidden" name="sender_id" value="<?php echo e($sender_id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lok3rn5/fastlobby.com/resources/views/templates/chat/item.blade.php ENDPATH**/ ?>