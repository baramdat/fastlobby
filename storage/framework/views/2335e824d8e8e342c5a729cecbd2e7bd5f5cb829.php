                                    ...
                                    <?php if(isset($chats) && sizeof($chats)>0): ?>
                                        <?php $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='/inbox/<?php echo e($encrypted); ?>'><?php echo e(ucwords($sender->first_name)); ?> <?php echo e(ucwords($sender->last_name)); ?></td>
                                                                                        <td class="view-message clickable-row" data-href='/inbox/<?php echo e($encrypted); ?>'><?php echo e(empty($first) ? '': $first->subject); ?></td>

                                                <td class="view-message text-end fw-semibold clickable-row" data-href='/inbox/<?php echo e($encrypted); ?>'><?php echo e($chat->created_at->diffForHumans()); ?></td>
                                            </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lok3rn5/fastlobby.com/resources/views/templates/chat/list.blade.php ENDPATH**/ ?>