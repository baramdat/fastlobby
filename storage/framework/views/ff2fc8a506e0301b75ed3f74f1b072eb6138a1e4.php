...
<div class="main-container container-fluid">
            ...
            <div class="form-row align-items-center">
                ...
                <div class="col-1 col-lg-1 mb-1" style="display:none">
                    ...
                    <select class="form-control form-select" id="filterRole">
                        ...
                        <?php $__currentLoopData = $rolesArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div id="divLoader" class="text-center pt-5" style="display:block;height:300px;">
        ...
        <span>
            ...
            <i class="bx bx-loader-circle bx-spin"></i> <?php echo e(__('User are being loading.. It might take few seconds')); ?>.
    ...
    <div class="row text-center" id="divNotFound" style="display:none">
        ...
        <h6 class="mt-lg-5" style=""><i class="bx bx-window-close"></i> <?php echo e(__('No User Found')); ?> !</h6>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lok3rn5/fastlobby.com/resources/views/templates/users/dumi_user.blade.php ENDPATH**/ ?>