    ...
    <div class="content">
        ...
        <div class="row">
            <div class="d-flex justify-content-center">
                ...
                <a id="callDrop" data="<?php echo e($user_one); ?>" data-id="<?php echo e($user_two); ?>" href="javascript:void(0)" class="fe fe-phone-off text-center " style="padding:7px;border-radius:50%; font-size:30px;"></a>
            </div>
        </div>
    </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lok3rn5/fastlobby.com/resources/views/templates/chat/video_chat_room.blade.php ENDPATH**/ ?>