    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
              ...
              <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('tenant/all/camera/streaming')}}" target="_blank"><img src="{{asset('uploads/files/cctv.png')}}" style="width:20px;height:20px;"><span class="side-menu__label"  class="slide-item" style="margin-left:7px">Cameras</span></a>
            ...
            <li class="slide">
                ...
                <li class="slide">
                    ...
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fa fa-play"></i><span class="side-menu__label">Contents</span><i class="angle fe fe-chevron-right"></i></a>
   ...
   <li class="slide">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="/external/scan/{{$site->id}}" class="slide-item">External Walkin Appointment</a></li>
