    ...
    <div class="main-container container-fluid">
        ...
        <div class="page-header">
            ...
            <div>
                ...
                <h1 class="page-title">Wayfinder List </h1>

                <ol class="breadcrumb">

                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Home</a> </li>

                    <li class="breadcrumb-item active" aria-current="page">Wayfinder List </li>

                </ol>

            </div>

            <a role="button" class="btn btn-dealer" href="{{ url('/add/picture') }}"> <span
            ...
            <div class="card-body px-3 py-2 pt-3">
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-12 col-lg-6 mb-1">
                        ...
                        <label for="" class="fw-bold mb-1">Search Destination :</label>

                        <input type="text" id="search" class="form-control" placeholder="Destination name..">
                    ...
                    <div class="card-header  mx-1">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h6 class="mb-0 mt-1 text-muted">Wayfinder List</h6>
                                    ...
                                    <div class="panel-body tabs-menu-body border-0 pt-0">
                                        ...
                                        <div id="divLoader" class="text-center pt-5" style="height:300px;">
                                            ...
                                            <span>
                                                ...
                                                <i class="fe fe-spinner fa-spin"></i> WayFinder are being loading.. It
