...
<div class="main-container container-fluid">
    ...
    <div class="page-header">
        ...
        <a role="button" class="btn btn-dealer" href="{{ url('/integrator/door/add')}}"> <span class="fe fe-plus fs-14"></span>
            Add Door</a>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        $(document).on('click', '.btnDelete', function (e) {
            ...
            .then((deleteThis) => {
                if (deleteThis.isConfirmed) {
                    $.ajax({
                        url: '/api/integrator/door/delete/' + id,
                        type: "delete",
                        dataType: "JSON",
                        success: function (response) {
                            console.log(response)
