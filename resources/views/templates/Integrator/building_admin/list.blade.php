...
<div class="main-container container-fluid">
    ...
    <div class="page-header">
        ...
        <a role="button" class="btn btn-dealer" href="{{url('integrator/user/add')}}">
    ...
    <div id="divLoader" class="text-center pt-5" style="display:block;height:300px;">
        <span>
            <i class="bx bx-loader-circle bx-spin"></i> {{__('Building Admin are being loading.. It might take few seconds')}}.
        </span>
    </div>
    <div class="row text-center" id="divNotFound" style="display:none">
        <h6 class="mt-lg-5" style=""><i class="bx bx-window-close"></i> {{__('No Building Admin Found')}} !</h6>
    </div>
    <!-- pagination -->
    <div class="row mb-5">
        <div class="col-12">
