    ...
    <div class="main-container container-fluid">
        ...
        <div class="page-header">
            ...
            <div>
                ...
                <h1 class="page-title">Screen List</h1>

                <ol class="breadcrumb">

                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Home</a> </li>

                    <li class="breadcrumb-item active" aria-current="page">Screen List</li>
            ...
            <div class="card-body px-3 py-2 pt-3">
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-12 col-lg-6 mb-1">
                        ...
                        <label for="" class="fw-bold mb-1">Search screen :</label>

                        <input type="text" id="search" class="form-control" placeholder="Screen Name..">
                    ...
                    <div class="card-header  mx-1">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h6 class="mb-0 mt-1 text-muted">Screen list</h6>
                                    ...
                                    <div class="panel-body tabs-menu-body border-0 pt-0">
                                        ...
                                        <div id="divLoader" class="text-center pt-5" style="height:300px;">
                                            ...
                                            <span>
                                                ...
                                                <i class="fe fe-spinner fa-spin"></i> Screens are being loading.. It
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if (response["status"] == "fail") {
                                        ...
                                        Swal.fire("Failed!", "Failed to delete screen.",

                                            "error");

                                    } else if (response["status"] == "success") {

                                        Swal.fire("Deleted!", "Screen has been deleted.",
