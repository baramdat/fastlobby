...
<head>
    ...
    <title>Add Appointment - {{ env('APP_NAME') }}</title>
                            ...
                            <td>
                                ...
                                <div class="text" style=" text-align: left;">
                                    ...
                                    <p>
                                        ...
                                        <strong>{{ ucwords($data['visitor_name']) }}</strong> sent following message for
                                        you.

                                        <br>
                                    <div class="callout-container">
                                        <p>{{ ucwords($data['visitor_message']) }}</p>
                                    </div>
                                    {{-- <strong>{{$data["visitor_message"]}}</strong> --}}
                                    ...
                                    <p>
                                        ...
                                        <b>Regards, </b><br><br><span style="color:gray;"> {{ env('APP_NAME') }}</span>
                                        | <a href="https://www.fastlobby.com" target="_blank"
                                            style="text-decoration:none;color: #006f94;">www.fastlobby.com</a>
