...
@section('content')
                    ...
                    <div class="card border p-0 overflow-hidden shadow-none">
                        ...
                        <div class="card-body py-3 px-4"
                            ...
                            <div class="row">
                                ...
                                <?php
                                $today = \Carbon\Carbon::now()->format('Y-m-d');
                                $apps = App\Models\Appointment::whereDate('created_at', $today)
                                    ->orderBy('id', 'DESC')
                                    ->get();
                                ?>
                                            ...
                                            <tbody>
                                                ...
                                                @if (sizeof($apps) > 0)
                                                    @foreach ($apps as $key => $app)
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td><b>{{ ucwords($app->user->first_name) }}
                                                                    {{ $app->user->last_name }}</b></td>
                            ...
                            <form id="add_form">
                                ...
                                <div class="form-row align-items-center">
                                    <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1">
                                        <label for="" class="fw-bold mb-1">Visitor: <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="name" name="name"
                                            placeholder="John Doe.." required>
                                    </div>
                                    <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1">
                                        <label for="" class="fw-bold mb-1">Email Address: <span
                                                class="text-danger">*</span></label>
                                        <input type="email" class="form-control" id="email" name="email"
                                            placeholder="example@example..." required>
                                    </div>
                                    <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1">
                                        <label for="" class="fw-bold mb-1">Phone Number: <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control telephone_number cursor-left"
                                            name="phone" placeholder="+13020..">
                                    </div>
                                    <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1">
                                        <label for="" class="fw-bold mb-1">Appointment Date: <span
                                                class="text-danger">*</span></label>
                                        <input type="date" class="form-control" name="date">
                                    </div>
                                    <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1">
                                        <label class="fw-bold mb-1">Appointment Time: <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1 ">
                                        ...
                                        <button id="btnSubmit" type="submit" class="btn btn-primary btn-block"><i
                                                class="fa fa-spinner fa-pulse" style="display: none;"></i> Add
                                            Appointment</button>
                                    </div>
                                </div>
                            </form>
                                        ...
                                        <div class="">
                                            <div class="panel panel-primary">
                                                <div class="panel-body tabs-menu-body border-0 pt-0">
                                                    ...
                                                    <div id="sitedivLoader" class="text-center pt-5"
                                                        style="height:300px;">
                                                        <span>
                                                            <i class="fe fe-spinner fa-spin"></i> Sites are being loading..
                                                            It
                                                            might take few
                                                            seconds.
                                                        </span>
                                                    </div>
                                                    <div class="row text-center" id="sitedivNotFound"
                                                        style="display:none">
                                        ...
                                        <div class="">
                                            <div class="panel panel-primary">
                                                <div class="panel-body tabs-menu-body border-0 pt-0">
                                                    ...
                                                    <div id="appointmentdivLoader" class="text-center pt-5"
                                                        style="height:300px;">
                                                        <span>
                                                            <i class="fe fe-spinner fa-spin"></i> Appointments are being
                                                            loading.. It
                                                            might take few
                                                            seconds.
                                                        </span>
                                                    </div>
                                                    <div class="row text-center" id="appointmentdivNotFound"
                                                        style="display:none">
                                                        <h6 class="mt-lg-5"><i class="bx bx-window-close"></i>
    ...
    <script>
        ...
        // handleBarcode('AP-MSZvPNZiFcN2gXG');
        ...
        function handleBarcode(scanned_barcode) {
            ...
            $.ajax({
                type: "get",
                url: "/api/get/appointment/barcode/details/" + data,
                dataType: "JSON",
                success: function(response) {
                    if (response["status"] == "fail") {
                        toastr.error('Failed', response["msg"])
                    } else if (response["status"] == "success") {
                        if ((is_auth == 1 && is_guard == 1) || response["ap-status"] == 'pending') {
                            informClient(response["id"]);
                        }
                    }
                }
            });
