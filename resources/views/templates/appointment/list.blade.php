    ...
    <div class="main-container container-fluid">
                    ...
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1">
                            <label for="" class="fw-bold mb-1">Phone Number: <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control telephone_number cursor-left" name="phone"
                                id="phone" placeholder="+13020..">
                        </div>
                        <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1">
                        ...
                        <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1 ">
                            ...
                            <button id="btnSubmit" type="submit" class="btn btn-primary btn-block"><i
                                    class="fa fa-spinner fa-pulse" style="display: none;"></i> Add Appointment</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="card">
            <div class="card-body px-3 py-2 pt-3">
                <div class="form-row align-items-center">
                    <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1">
                        <label for="" class="fw-bold mb-1">Search by names :</label>
                        <input type="text" id="search" class="form-control" placeholder="John Doe..">
                    </div>
                    <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1">
                        <label for="" class="fw-bold mb-1">Serach by phone no.</label>
                        <input type="number" id="filterPhone" name="filterPhone" class="form-control"
                            placeholder="+9234...">
                    </div>
                    <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1">
                    ...
                    <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1">
                        <label for="" class="fw-bold mb-1">Search by date:</label>
                        <input class="form-control" type="text" id="filterDate" name="filterDate">
                    </div>
                    <div class="col-lg-2 col-xl-2 col-md-4 col-sm-6 mb-1 ">
                        <label for="" class="mb-1"></label>
