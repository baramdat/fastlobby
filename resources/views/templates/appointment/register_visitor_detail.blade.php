                                ...
                                <div class="text-center chat-image mb-5">
                                    <div class=" chat-profile mb-3 brround">
                                        @if ($client->image == null)
                                            <img id="" alt="avatar"
                                                src="{{ asset('assets/images/users/avatar-121.png') }}" class="brround"
                                                style="width:200px !important"></a>
                                        @else
                                            <img id="" src="{{ asset('uploads/files/' . $client->image) }}"
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <span class="mx-2">
                                            <i class="fa fa-map-marker fs-20"></i><strong>
                                                {{ ucwords($client->site->name) }}</strong>
                                        </span><br>
                                        <span>
                                    ...
                                    @if ($app->status == 'pending')
                                        <div class="text-center">
                                            <a href="{{ url('qr-scan') }}" id="btnElm"
                                                class="btn btn-success rounded-circle design"
                                                style="font-size:60px;font-weight:600;">
                                                GO
                                            </a>
                                            <p id="counter-sec" style="margin-top:10px;color:red;display:none">
                                                You'll be automatically redirected in <span id="count">5</span>
                                                seconds...</p>
                                        </div>
                                    @else
                                        <div class="text-center">
