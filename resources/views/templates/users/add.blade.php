                    ...
                    <form action="" id="add_user">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    @if(Auth::user()->hasRole('Admin'))
                                        ...
                                        <select class="form-control form-select" id="roleId" name="role" required>
                            ...
                            ?>
                             ...
                             <div class="col-lg-6" id="divSiteId">
                                <div class="form-group">
                                    <label class="form-label mb-0">Site:</label>

                                    <select class="form-control form-select" id="site_id" name="site_id">
